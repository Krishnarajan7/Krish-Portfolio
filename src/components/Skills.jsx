...
const Skills = ({ isDarkMode }) => {
  ...
  return (
    <section id="skills" className={`py-16 sm:py-20 ${isDarkMode ? 'bg-space-darker/50' : 'bg-gray-50'}`}>
        ...
        <div className="relative mt-10 sm:mt-12">
          ...
          {!isMobile && (
            <>
              ...
              <DecoStar position="-right-6 top-20" size="sm" animationDelay={1.2} />
              <DecoStar position="left-1/4 -bottom-6" size="sm" animationDelay={0.7} />
            </>
          )}
          ...
          <div className="mt-12 md:mt-16 frosted-glass rounded-lg p-5 sm:p-6 relative">
            ...
            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 flex space-x-4 sm:space-x-8">
              <DecoStar size="sm" className="text-space-accent/70 animate-twinkle" animationDelay={0.3} />
              <DecoStar size="lg" className="text-space-accent animate-twinkle-slow" animationDelay={0.8} />
              <DecoStar size="sm" className="text-space-accent/70 animate-twinkle-fast" animationDelay={0.1} />
            </div>
            
            <h3 className="text-lg sm:text-xl font-bold text-white mb-4 mt-2">Additional Technologies & Concepts</h3>
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {[
                "Next.js", "Redux", "SASS", "Vue.js", "Express", "MongoDB", 
                "Firebase", "Jest", "CI/CD", "Responsive Design", "Accessibility", 
                "Performance Optimization", "PWA", "Agile/Scrum"
              ].map((tech, idx) => (
                <span 
                  key={idx} 
