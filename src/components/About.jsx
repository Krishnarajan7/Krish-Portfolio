...
const About = ({ isDarkMode }) => {
  ...
  useEffect(() => {
    ...
    const updateMoonPosition = () => {
      ...
      moonRef.current.style.transform = `translate(${x}px, ${y}px) rotate(${
        now * 15
      }deg)`;
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
          ...
          <div className="space-y-6" ref={contentRef} style={{ opacity: 0 }}>
            ...
            <p className="text-white/70">
              ...
              cloud services, I enjoy crafting responsive, performant, and
              accessible web applications that deliver exceptional user
              experiences. I'm particularly interested in creating solutions
              that bridge the gap between complex technical challenges and
            ...
            <p className="text-white/70">
              ...
              latest industry trends. I believe in continuous learning and
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
              <div className="frosted-glass rounded-lg p-4 flex flex-col items-center text-center transform hover:scale-105 transition-all duration-300">
                ...
                <p className="text-white/60 text-sm">
                  Well-structured, maintainable solutions
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="cosmic-card p-6 relative">
                ...
                <div className="relative pl-6 pb-8">
                  ...
                  <p className="text-white/70 mt-2">
                    Leading development of enterprise SaaS applications using
                    React, Node.js, and AWS. Mentoring junior developers and
                ...
                <div className="relative pl-6 pb-8">
                  ...
                  <p className="text-white/70 mt-2">
                    ...
                    React, Express, and MongoDB. Implemented responsive designs
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div
                  key={idx}
                  className="frosted-glass rounded-lg p-4 flex flex-col items-center text-center"
                >
